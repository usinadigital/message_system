...
public interface Constants {
	...
	public static final String FILE_MESSAGE_TITLE = "MessageTitle";
	public static final String FILE_MESSAGE_TEXT = "MessageText";
	public static final String FILE_MESSAGE_DATE = "MessageDate";
